	...
	<div id="wrapper">
		<header> 
			<div class="nonprofit-header">
				<img class="nonprofit-header-bgimg" src="<?php esc_url( header_image() ); ?>" height="<?php echo esc_html( get_custom_header()->height ) ;  ?>" width="<?php echo esc_html( get_custom_header()->width ); ?>" alt="" />
