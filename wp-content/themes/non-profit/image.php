						...
						<article>
							...
							<div class="nonprofit-post-date">
								<p><?php echo __( 'Posted on', 'non-profit' ). '&nbsp;'; ?>
									...
									<?php echo '&nbsp;' . __( 'at', 'non-profit' ); ?> <a href="<?php echo esc_url(wp_get_attachment_url() ); ?>" target="_blank"><?php echo $metadata[ 'width' ].' &times; '.$metadata[ 'height' ]; ?></a>
									<?php _e( 'in', 'non-profit' ); ?> <a href = "<?php echo esc_url( get_permalink( $post->post_parent ) ); ?>"><?php echo get_the_title( $post->post_parent ); ?></a>
