		...
		<footer class="nonprofit-main-footer">
			<div class="nonprofit-footer">
				<div class="nonprofit-footer-powered">
					<p><?php printf( __( 'Powered by %1$s and %2$s', 'non-profit' ), '<a href="' . esc_url( wp_get_theme()->get( 'AuthorURI' ) ) . '">BestWebSoft</a>', '<a href="' . esc_url( 'http://wordpress.org' ) .'">WordPress</a>' ); ?></p>
